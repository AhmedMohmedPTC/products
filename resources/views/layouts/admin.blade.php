    ...
    <div class="wrapper">
            ...
            <div class="sidebar">
                <div>
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="{{asset('dist/img/adminLogo.png')}}" class="img-circle elevation-2" alt="User Image">

                        </div>
                        <div class="info">
                            <a href="#" class="d-block">Ahmed Mohmed</a>
                        </div>
                    </div>
                 ...
                 with font-awesome or any other icon font library -->
                            <li class="nav-item has-treeview menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{url('viewProd')}}" class="nav-link">
                                            <i class="fa fa-circle-o nav-icon"></i>
                                            <p>عرض المنتجات</p>
                                        </a>
                                    </li>
      ...
      @yield('content')
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong> &copy; 2022 <a href="http://github.com/AhmedMohmedPTC/">Ahmed Mohmed</a></strong>
        </footer>
    </div>
    <!-- ./wrapper -->
