...
<head>
    ...
    <link href="dist/adminlte/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="index.html">سوق الاسواق</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            <ul class="navbar-nav m-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="{{url('/')}}">المنتجات <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('home')}}">تسجيل الدخول</a>
                </li>
            </ul>
        ...
        <div class="col-sm">
            <div class="card">
                <div class="card-header bg-primary text-white text-uppercase">
                    <i class="fa fa-star"></i> اَخر المنتجات
                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <a href="cart.html" class="btn btn-success btn-block">{{$product->amount}}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
